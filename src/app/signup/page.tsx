    ...
    <div className="min-h-screen bg-[#F5F0E8] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Start planning adventures</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-200 rounded-full font-semibold text-gray-700 hover:bg-gray-50 transition mb-6"
          >
